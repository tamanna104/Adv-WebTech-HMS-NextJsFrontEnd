...
export default function dashBoard(props) {
  ...
  export async function getServerSideProps() {
    const adminCount = await axios.get('http://localhost:3000/admin/countAdmin');
    const hospitalCount = await axios.get('http://localhost:3000/hospital/countHospital');
    const bloodBankCount = await axios.get('http://localhost:3000/bloodBank/countBloodBank');
